          ...
          {user ? (
            <>
              ...
              <View className="rounded-card border border-ledger-line bg-ledger-background p-3">
                <Text className="text-sm leading-5 text-ledger-muted">
                  New vehicles are saved to your account. Cloud odometer,
                  service, repair, reminder, attachment, and CSV sync are coming
                  soon.
                </Text>
              </View>
              {hasLocalGuestRecords ? (
                <View className="rounded-card border border-ledger-line bg-ledger-background p-3">
                  <Text className="text-sm leading-5 text-ledger-muted">
                    ...
                    cloud records will be saved to your account.
                  </Text>
                </View>
              ) : null}
              <Pressable
