...
const localDataMessage =
  "Cloud sync for existing local records is coming soon. New cloud vehicles, odometer readings, and service records will be saved to your account.";
...
export default function SignUpScreen() {
  ...
  const submit = async () => {
    ...
    if (result.needsEmailConfirmation) {
      setFeedback(
        "Check your email to confirm your account. New cloud vehicles, odometer readings, and service records will be available after sign-in.",
      );
      setIsSubmitting(false);
      return;
    }
    ...
    setFeedback(
      (await hasAnyLocalGuestData())
        ? localDataMessage
        : "Account created. New vehicles, odometer readings, and service records will be saved to your account.",
    );
    setIsSubmitting(false);
  };
      ...
      <ScrollView contentContainerClassName="gap-5 px-6 py-6">
        <View className="gap-2 pt-4">
          ...
          <Text className="text-base leading-6 text-ledger-muted">
            ...
            this device, and new vehicles, odometer readings, and service
            records can be saved to your account.
          </Text>
        </View>
        ...
        {!isConfigured ? (
          ...
          <View className="gap-3 rounded-card border border-ledger-line bg-ledger-surface p-4">
            ...
            <Text className="text-sm leading-5 text-ledger-muted">
              ...
              vehicle, odometer, and service records save to your account.
            </Text>
            <Pressable
