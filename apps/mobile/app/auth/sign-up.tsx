...
const localDataMessage =
  "Account created. Local records are still on this device. Vehicle, odometer, service record, and repair record migration tools are available in Settings, and later reminders and attachments will migrate in future slices. New cloud records you add while signed in will save to your account.";
...
export default function SignUpScreen() {
  ...
  const submit = async () => {
    ...
    if (result.needsEmailConfirmation) {
      setFeedback(
        "Check your email to confirm your account. New cloud vehicles, odometer readings, service records, and repair records will be available after sign-in.",
      );
      setIsSubmitting(false);
      return;
    }
    ...
    setFeedback(
      migrationSummary.hasGuestData
        ? localDataMessage
        : "Account created. New vehicles, odometer readings, service records, and repair records will be saved to your account.",
    );
    setIsSubmitting(false);
  };
      ...
      <ScrollView contentContainerClassName="gap-5 px-6 py-6">
        <View className="gap-2 pt-4">
          ...
          <Text className="text-base leading-6 text-ledger-muted">
            ...
            this device, and new vehicles, odometer readings, service records,
            and repair records can be saved to your account.
          </Text>
        </View>
        ...
        {!isConfigured ? (
          ...
          <View className="gap-3 rounded-card border border-ledger-line bg-ledger-surface p-4">
            ...
            <Text className="text-sm leading-5 text-ledger-muted">
              ...
              vehicle, odometer, service, and repair records save to your
              account.
            </Text>
            <Pressable
